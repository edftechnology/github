...
### Com submódulo
O repositório principal sabe que o diretório `apps/audithas/` é um repositório Git separado.
...
git submodule add https://github.com/eden/audithas.git apps/audithas

# repetir para os outros
git submodule add https://github.com/eden/k_means_python_master_degree.git apps/k_means_python_master_degree
git submodule add https://github.com/eden/praeparatio.git apps/praeparatio

# commit as mudanças
git commit -m "Adicionando apps como submódulos"
```
